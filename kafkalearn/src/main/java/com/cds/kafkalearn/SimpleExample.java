...
public class SimpleExample {
    public static void main(String args[]) {
        ...
        try {
            ...
            //            brokers.add("207.207.77.62");
            brokers.add("208.208.102.212");
            brokers.add("208.208.102.213");
            brokers.add("208.208.102.214");
//            brokers.add("208.208.102.143");
//            brokers.add("208.208.102.144");
            example.run(90, "salut", 2, brokers, 9092);
        } catch (Exception e) {
    ...
    public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers,
        ...
        while (a_maxReads > 0) {
            ...
            for (MessageAndOffset messageAndOffset : fetchResponse
                .messageSet(a_topic, a_partition)) {

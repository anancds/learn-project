...
//        generateData();
        ...
        SimpleConsumer simpleConsumer =
            new SimpleConsumer("207.207.77.62", KafkaProperties.KAFKA_SERVER_PORT,
                KafkaProperties.CONNECTION_TIMEOUT, KafkaProperties.KAFKA_PRODUCER_BUFFER_SIZE,
        ...
        req = new FetchRequestBuilder().clientId(KafkaProperties.CLIENT_ID)
